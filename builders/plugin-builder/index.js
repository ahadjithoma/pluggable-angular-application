...
function buildPlugin(options, context, transforms = {}) {
    ...
    return result.pipe(operators_1.tap(() => { patchEntryPoint(''); }));
}
...
function patchWebpackConfig(config, options) {
    ...
    config.externals = {
        ...
        'src/app/application-core/application-core.module': 'app.core',
        'src/app/services/pluggin-store.service': 'store',
